...
const Comment = ( {file, startLineNumber, startColumn, text, collaborators, commentID, handleCloseComment} ) => {
    // console.log("making new comment", commentID);
    return  (
        <div className="comment">
            <p>{file} @ Ln: {startLineNumber} Col: {startColumn} <br></br>
            <h3>Comment</h3><p>{text}</p>
            <h3>Collaborators</h3><p>{collaborators}</p>
            </p>
        ...
        <div className='editor-comments'>
            ...
            <div className="comment-container">
                ...
                {((startColumn != endColumn) || (startLineNumber != endLineNumber)) &&
                    <div className="comment">
                        <p>{currentFile} @ Ln: {startLineNumber} Col: {startColumn} <br></br>
                        <input
                            value={commentText}
